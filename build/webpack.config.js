...
module.exports = {
    ...
    entry: {
        'main': './src/app/js/main',
        'charts': './src/app/js/charts',
        'custom': './src/app/js/custom'
    },
    ...
    plugins: [
        ...
        new CopyWebpackPlugin([
            {
                from: { glob:'./src/app/html/*.html'},
                to: './',
                flatten: true
            },
            {
                from: { glob:'./src/app/html/*.ico'},
                to: './',
                flatten: true
            },
            {
                from: { glob:'./src/app/html/*.txt'},
                to: './',
                flatten: true
            },
            {
                from: { glob:'./src/app/js/jquery-manager/*.*'},
                to: './js/jquery-manager',
                flatten: true
            },
            {
                from: { glob:'./src/app/js/jquery-manager/plugins/*.*'},
                to: './js/jquery-manager/plugins',
                flatten: true
            },
            {
